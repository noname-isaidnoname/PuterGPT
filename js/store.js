...
export const themeDefinitions = {
  dark: {
    ...
    cssVars: {
      ...
      '--toast-info-bg': 'var(--bg-secondary)',
      '--toast-info-border': 'var(--border-color)',
      '--toast-info-text': 'var(--text-primary)',
      '--toast-warning-bg': '#773e10',
      '--toast-warning-border': '#f59e0b',
      '--toast-warning-text': '#0d0d0d',
      '--toast-error-bg': '#7c1313',
      '--toast-error-border': '#ef4444',
      '--toast-error-text': '#ffffff',
      '--toast-success-bg': '#0d7058',
      '--toast-success-border': '#10a37f',
